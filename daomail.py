...
def fakeEmail():
  ...
  if chon == '2':
    ...
    Domain = input(" \033[1;34m√ Nhập Domain(ex: yahoo) : ")
    file_email = input(" \033[1;34m√Nhập File Lưu Mails(ex: email.txt) : ")
    n = 0
    for fake in range(so_luong):
      ...
      print (" [" + str(n) + "] => |DvMxhVn.Com|     " + fake_email)
...
def checkhotmail():
  ...
  try:
    ...
    hotmail = open(input(" \033[1;34m=> Nhập File Chứa Hotmail(ex: hotmail.txt) : ")).readlines()
  ...
  def run_check_hotmail(hot_mail):
    ...
    if kq == None:
      print (" \033[1;31m=> |\033[1;37mDvMxhVn.Com\033[1;31m|Email Live|" + hot_mail + "@hotmail.com")
      open(hotmail_live,'a').write(hot_mail + "@hotmail.com" + "\n")
    else:
      print (" \033[1;32m=> |\033[1;37mDvMxhVn.Com\033[1;32m|Email Die|" + hot_mail + "@hotmail.com")
...
def checkyahoo():
  ...
  def run_check_yahoo(yid):
    ...
    if KQ == None:
      print(" \033[1;32m=> |\033[1;37mDvMxhVn.Com\033[1;32m|Email Die| " + yid + "@yahoo.com")
      open(yahoo_die,"a").write(yid + "@yahoo.com" + "\n")
    else:
      print(" \033[1;31m=> |\033[1;37mDvMxhVn.Com\033[1;31m|Email Live| " + yid + "@yahoo.com")
...
def checkvalid():
  ...
  for line_email_fb in fileEmail:
    ...
    if kq_check == None:
      ...
      print (" \033[1;31m=> |\033[1;37m"+str(b)+"\033[1;31m| Không Liên Kết |" + email_fb)
...
def logo():
  logo = """    
                  ...
                  \033[0;33m Tool Đào Mail India - Việt Nam - Us 
                  \033[1;34m=> YTB : PQM TOOL
                  \033[1;32m=> Facebook : Phạm QUang Minh 
                  \033[1;31m=> Like Sub Giá Rẻ Tại : DvMxhvn.com 
...
def process_menu():
  menu = """
                ...
                \033[1;31m[-----------------------------]
                      ...
                      \033[1;34m4. Tool Check Valid Facebook.
